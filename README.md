...
El módulo permite validar productos, controlar niveles de stock, detectar productos con bajo stock, calcular totales de pedidos y verificar permisos básicos de usuario para la carga de información.
...
```bash
git clone https://github.com/usuario/empreassist.git
cd empreassist
npm install
```
...
6. Ejecuta la compilación con `npm run build`.
...
- `dev/waniukiewicz-ci`: configuración de CI/CD y linter.

## Pruebas unitarias incluidas

El proyecto incluye al menos cinco pruebas unitarias sobre el módulo de stock y pedidos:
...
Cada vez que un integrante sube cambios al repositorio o crea un pull request, GitHub Actions ejecuta automáticamente el pipeline. Si el código no compila, si un test falla o si el linter detecta errores de estilo, el pipeline queda en estado fallido. Esto evita integrar cambios defectuosos a la rama principal.

## Enlaces para completar antes de entregar

- Repositorio: https://github.com/nicolaswaniukiewicz/empreassist-ci/blob/main/.github/workflows/ci.yml
